...
// Vite exposes build-time env on import.meta.env (the Next app read the same value
// from process.env.NEXT_PUBLIC_API_URL). This is the only line that differs from the
// Next.js client; everything below is identical.
